    ...
    <div className="max-w-5xl">
      ...
      <div className="flex gap-3 mb-8 flex-wrap">
        <Link
          ...
          className="inline-flex items-center gap-2 bg-white border border-[#ebebeb] text-charcoal-700 text-sm px-4 py-2.5 rounded-xl font-medium hover:border-charcoal-200 hover:text-charcoal-900 transition-colors"
        >
