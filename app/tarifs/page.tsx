    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-lg mx-auto px-4 sm:px-6">
          <div className="bg-[#F8FAF9] rounded-2xl border border-gray-200 p-8">
            {/* Badge */}
            {hasOffer && (
            ...
            <div className="mb-6">
              {hasOffer ? (
                <div className="flex items-end gap-3">
                  ...
                  <div className="mb-2">
                    <p className="text-sm text-gray-400 line-through">299 $/an</p>
                    <p className="text-sm text-gray-500">première année</p>
                  </div>
                </div>
              ) : (
                <div className="flex items-end gap-2">
                  <span className="text-6xl font-bold text-primary">299 $</span>
                  <span className="text-gray-500 mb-2">/an</span>
                </div>
              )}
              <p className="text-sm text-gray-400 mt-1">par chalet · tout inclus</p>
            </div>
            ...
            <Link
              ...
              className="w-full inline-flex items-center justify-center bg-primary text-white font-bold py-4 rounded-xl hover:bg-primary/90 transition-colors text-base"
            >
              ...
              >
                ...
                <div className="px-6 py-4 text-center">
                  {row.airbnb === true ? (
                    ...
                    <span className="text-sm text-gray-500">{row.airbnb}</span>
                  )}
                </div>
              </div>
            ))}
