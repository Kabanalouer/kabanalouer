...
const SYSTEM_PROMPT =
  ...
  "Ta réponse doit faire MAXIMUM 199 caractères, espaces inclus. Compte bien tes caractères avant de répondre. Ne retourne que la légende, rien d'autre. " +
...
export async function POST(request: Request) {
  ...
  if (!(await checkAiRateLimit(supabase, user.id, "generate-caption"))) {
  ...
  try {
      ...
      messages: [
        {
          ...
          content: [
            ...
            {
              type: "text",
              text: "Génère une légende pour cette photo. Retourne UNIQUEMENT la légende, sans guillemets, sans ponctuation finale, sans markdown. Ta réponse doit faire 199 caractères maximum, espaces inclus. Ne dépasse jamais cette limite.",
            },
          ],
        },
      ],
    ...
    const caption = raw.replace(/^["«»"]+|["«»"]+$/g, "").slice(0, 199);
