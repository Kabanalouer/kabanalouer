...
export default function AmenitiesSection({ amenities }: { amenities: AmenityValue[] }) {
  ...
  return (
    <div>
      <h2 className="font-semibold text-charcoal-800 mb-4">{title}</h2>
      ...
      {hasMore && (
        <button
          ...
          className="mt-4 text-sm font-medium text-primary border border-primary/30 px-5 py-2.5 rounded-full hover:bg-primary/5 transition-colors"
        >
